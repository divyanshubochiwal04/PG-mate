export type InvoiceStatusDto = 'DRAFT' | 'ISSUED' | 'PARTIALLY_PAID' | 'PAID' | 'OVERDUE' | 'CANCELLED';
export type InvoiceChargeTypeDto = 'BASE_RENT' | 'FACILITY' | 'MESS' | 'ADDITIONAL_CHARGE' | 'LATE_FEE' | 'DISCOUNT' | 'ADJUSTMENT';
