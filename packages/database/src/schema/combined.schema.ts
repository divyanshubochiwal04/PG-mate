...
import type {
  ResidentAdditionalChargesTable,
  ResidentCommercialAgreementsTable,
  ResidentFacilitiesTable,
} from './commercial.schema';
import type {
  MessBuildingAssignmentsTable,
  MessConfigurationsTable,
  MessesTable,
  MessExpensesTable,
  MessInventoryItemsTable,
  MessInventoryTransactionsTable,
  MessMealConsumptionsTable,
  MessMealPlansTable,
  MessMealTypesTable,
  MessMenuItemsTable,
  MessMenusTable,
  MessProcurementItemsTable,
  MessProcurementsTable,
  MessVendorsTable,
  ResidentMessSubscriptionsTable,
} from './mess.schema';
...
export type DatabaseSchema = AuthDatabaseSchema &
  ...
  CommercialDatabaseSchema &
  MessDatabaseSchema &
  BillingDatabaseSchema &
