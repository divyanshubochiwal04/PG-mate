...
async function up(db) {
    ...
    await db.schema
        ...
        .addForeignKeyConstraint('fk_buildings_property_org', ['property_id', 'organization_id'], 'properties', ['id', 'organization_id'], (cb) => cb.onDelete('restrict'))
        .execute();
    // 3. Floors Table
    await db.schema
        .createTable('floors')
        ...
        .addForeignKeyConstraint('fk_floors_building_org', ['building_id', 'organization_id'], 'buildings', ['id', 'organization_id'], (cb) => cb.onDelete('restrict'))
        .execute();
    // 4. Rooms Table
    await db.schema
        .createTable('rooms')
        ...
        .addColumn('capacity', 'integer', (col) => col.notNull().check((0, kysely_1.sql) `capacity >= 1`))
        .addColumn('display_order', 'integer', (col) => col.notNull().defaultTo(0))
        .addColumn('status', 'varchar(50)', (col) => col.notNull().defaultTo('ACTIVE'))
        .addColumn('created_at', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        .addColumn('updated_at', 'timestamptz', (col) => col.notNull().defaultTo((0, kysely_1.sql) `now()`))
        ...
        .addForeignKeyConstraint('fk_rooms_floor_org', ['floor_id', 'organization_id'], 'floors', ['id', 'organization_id'], (cb) => cb.onDelete('restrict'))
        .addForeignKeyConstraint('fk_rooms_building_org', ['building_id', 'organization_id'], 'buildings', ['id', 'organization_id'], (cb) => cb.onDelete('restrict'))
        .addForeignKeyConstraint('fk_rooms_property_org', ['property_id', 'organization_id'], 'properties', ['id', 'organization_id'], (cb) => cb.onDelete('restrict'))
        .execute();
    // 5. Beds Table
    await db.schema
        .createTable('beds')
        ...
        .addForeignKeyConstraint('fk_beds_room_org', ['room_id', 'organization_id'], 'rooms', ['id', 'organization_id'], (cb) => cb.onDelete('restrict'))
        .execute();
    // 6. Facilities Table
    await db.schema
    ...
    await db.schema
        ...
        .addForeignKeyConstraint('fk_prop_fac_property', ['property_id', 'organization_id'], 'properties', ['id', 'organization_id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_prop_fac_facility', ['facility_id', 'organization_id'], 'facilities', ['id', 'organization_id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        ...
        .addForeignKeyConstraint('fk_bldg_fac_building', ['building_id', 'organization_id'], 'buildings', ['id', 'organization_id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_bldg_fac_facility', ['facility_id', 'organization_id'], 'facilities', ['id', 'organization_id'], (cb) => cb.onDelete('cascade'))
        .execute();
    ...
    await db.schema
        ...
        .addForeignKeyConstraint('fk_room_fac_room', ['room_id', 'organization_id'], 'rooms', ['id', 'organization_id'], (cb) => cb.onDelete('cascade'))
        .addForeignKeyConstraint('fk_room_fac_facility', ['facility_id', 'organization_id'], 'facilities', ['id', 'organization_id'], (cb) => cb.onDelete('cascade'))
        .execute();
...
//# sourceMappingURL=00003_inventory_schema.js.map