...
import type { MessBuildingAssignmentRow, MessConfigurationRow, MessExpenseRow, MessInventoryItemRow, MessInventoryTransactionRow, MessMealConsumptionRow, MessMealPlanRow, MessMealTypeRow, MessMenuItemRow, MessMenuRow, MessProcurementItemRow, MessProcurementRow, MessRow, MessVendorRow, ResidentMessSubscriptionRow } from '../schema/mess.schema';
export interface MessRepository {
    ...
    listInventoryItems(organizationId: string, messId: string, page: number, pageSize: number): Promise<{
    ...
    listVendors(organizationId: string, page: number, pageSize: number): Promise<{
        items: MessVendorRow[];
        total: number;
    }>;
    createVendor(vendor: Omit<MessVendorRow, 'id' | 'created_at' | 'updated_at'>, trx?: Transaction<DatabaseSchema>): Promise<MessVendorRow>;
    listProcurements(organizationId: string, messId: string, page: number, pageSize: number): Promise<{
    ...
    listExpenses(organizationId: string, messId: string, page: number, pageSize: number): Promise<{
...
//# sourceMappingURL=mess-repository.interface.d.ts.map